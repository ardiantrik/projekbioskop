...
<div id="shell">
  <div id="header">
    ...
    <div id="sub-navigation">
      ...
      <div id="search">
        <form action="<?php echo base_url()."index.php/welcome/show_film/"; ?>" method="get" accept-charset="utf-8">
      ...
      <table width="100%" >
			...
			<?php foreach ($data as $data) { ?>
				<tr>
					...
					<td><?php if ($data['slot_show']<=0) { ?>
								<a href="<?php echo base_url()."index.php/welcome/show_book/".$data['id_show']; ?>" ><button disabled>Pesan Sekarang</button></a>
								<?php }else{ ?>
								<a href="<?php echo base_url()."index.php/welcome/show_book/".$data['id_show']; ?>"><button>Pesan Sekarang</button></a>
							<?php  }?>
					</td>
				</tr>
			<?php } ?>
